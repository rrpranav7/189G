from base.stage_3_code.Dataset_Loader_MNIST import Dataset_Loader
from base.stage_3_code.Method_CNN_MNIST import Method_CNN
from base.stage_3_code.Result_Saver import Result_Saver
from base.stage_3_code.Setting_Train_Test_MNIST import Setting_Train_Test
...
if 1:
    ...
    method_obj = Method_CNN('Convolution Neural Network', '', 10, 1)
